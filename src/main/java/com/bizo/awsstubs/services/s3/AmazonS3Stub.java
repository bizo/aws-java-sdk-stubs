...
public class AmazonS3Stub implements AmazonS3 {
  ...
  public ObjectListing listNextBatchOfObjects(final ObjectListing p) {
    return listObjects(new ListObjectsRequest(p.getBucketName(), p.getPrefix(), p.getNextMarker(), p.getDelimiter(), p.getMaxKeys()));
  }
    ...
    for (final S3ObjectInfo object : b.objects) {
      ...
      if (req.getDelimiter() != null) {
        ...
        if (subkey.contains(req.getDelimiter())) {
          final String prefix = object.key.substring(0, object.key.indexOf(req.getDelimiter(), req.getPrefix().length()) + 1);
  ...
  @Override
  public BucketTaggingConfiguration getBucketTaggingConfiguration(GetBucketTaggingConfigurationRequest arg0) throws AmazonServiceException, AmazonClientException {
    throw new UnsupportedOperationException();
  }
  ...
  @Override
  public BucketAccelerateConfiguration getBucketAccelerateConfiguration(GetBucketAccelerateConfigurationRequest r) {
    throw new UnsupportedOperationException();
  }

  @Override
  public void setBucketAccelerateConfiguration(String a, BucketAccelerateConfiguration b) {
    throw new UnsupportedOperationException();
  }

  @Override
  public void setBucketAccelerateConfiguration(SetBucketAccelerateConfigurationRequest r) {
    throw new UnsupportedOperationException();
  }
